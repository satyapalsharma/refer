                ...
                if phoneNumbers:
                    for number in phoneNumbers:
                        ...
                        m = {
                            'mobile': number,
                            'countryCode': '+91',
                            'text': "Hi! Your friend has invited you to FabHotels to get Rs. {0} off on your future bookings at FabHotels. Register using their referral code {1} or via this link fabhotels.com/invite/{1}".format(POINTS_PLAN_OBJECT['Instant Referral Discount']['points'], code),
